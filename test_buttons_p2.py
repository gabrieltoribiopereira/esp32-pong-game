...
print("\n" + "=" * 50)
print("TEST BOTONES - JUGADOR 2 (SLAVE)")
print("=" * 50)
...
peer = b'\x30\xc6\xf7\x21\xed\x7c' # MAC de P1

print("Mi MAC:", ":".join(["%02x" % b for b in mi_mac]))
print("Enviando a P1:", ":".join(["%02x" % b for b in peer]))

# Añadir peer
try:
    esp.add_peer(peer)
    print("Peer P1 añadido OK")
except:
    print("Peer P1 ya existe")

# Configuración Hardware
i2c = I2C(0, sda=Pin(21), scl=Pin(22), freq=400000)
display = ssd1306.SSD1306_I2C(128, 64, i2c)
boton_local = Pin(18, Pin.IN, Pin.PULL_UP)
...
while True:
    ...
    if utime.ticks_diff(current_time, ultimo_envio) > 50:
        ...
        try:
            if esp.send(peer, msg):
                # print("P2 -> P1 OK") # Debug opcional
                pass
            else:
                print("Error enviando a P1")
    ...
    # Actualizar pantalla
    display.fill(0)
    display.text("TEST BOTONES P2", 5, 0, 1)
